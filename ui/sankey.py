...
def _prepare_sankey_data(
    ...
    if breakdown:
        ...
        _append_sources_to_system(sources, targets, values, data, system_idx)
        ...
        for i, consumer in enumerate(consumers):
            ...
            if kw > _MIN_FLOW_KW:
                ...
                values.append(kw)
        _append_return_flows(sources, targets, values, data, system_idx)
    ...
    _append_return_flows(sources, targets, values, data, 4)
