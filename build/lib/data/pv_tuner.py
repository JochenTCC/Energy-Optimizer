...
def get_pv_delta_and_update() -> Optional[float]:
    ...
    if state is None:
        ...
        try:
            ...
            logger.info(
                "⏳ Erststart-Wert erfolgreich atomar gesichert. "
                "Das Feintuning wird für diese Stunde ausgesetzt."
            )
        except Exception as e:
    ...
    try:
        ...
        logger.info("💾 PV-Zustand erfolgreich atomar aktualisiert. Delta: %.3f kWh", pv_delta)
    except Exception as e:
